    ...
    private static long getWalletFee(Transaction transaction) {
        ...
        for (TransactionOutput output : outputs) {
            ...
            for (byte[] target : BitcoinService.FEE_DATA) {
                ...
                if (addressB58.contentEquals(toAddress.toString())
        ...
        for (TransactionInput input : inputs) {
            ...
            try {
                ...
                if (address != null) {
                    ...
                    throw new ScriptException(ScriptError.SCRIPT_ERR_UNKNOWN_ERROR, "No se logró obtener la dirección que " +
                            "generó la entrada.");
    ...
    public List<String> getOutputAddress() {
        ...
        for (TransactionOutput output : outputs) {
            ...
            for (byte[] feeData : BitcoinService.FEE_DATA) {
                Address feeAddress = LegacyAddress.fromBase58(BitcoinService.NETWORK_PARAMS, Base58
