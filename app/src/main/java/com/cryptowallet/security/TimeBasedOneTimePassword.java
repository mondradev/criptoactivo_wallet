...
public class TimeBasedOneTimePassword {
     ...
     * @return True if the authNumber matched the calculated number within the specified window.
     */
    private static boolean validateCurrentNumber(String base32Secret, int authNumber, int windowMillis, long timeMillis) throws GeneralSecurityException {
        ...
        long timeStepMillis = TimeBasedOneTimePassword.DEFAULT_TIME_STEP_SECONDS * 1000;
        for (long millis = from; millis <= to; millis += timeStepMillis) {
            long compare = generateNumber(base32Secret, millis, TimeBasedOneTimePassword.DEFAULT_TIME_STEP_SECONDS);
     ...
     * output.
     */
    private static String generateCurrentNumberString(String base32Secret) throws GeneralSecurityException {
     ...
     * output.
     */
    private static String generateNumberString(String base32Secret, long timeMillis, int timeStepSeconds)
            throws GeneralSecurityException {
     ...
     * @return A number which should match the user's authenticator application output.
     */
    private static long generateNumber(String base32Secret, long timeMillis, int timeStepSeconds)
            throws GeneralSecurityException {
